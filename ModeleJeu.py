...
class ModeleJeu:
    ...
    def __init__(self, container):
        ...
        self.rectangleBleuGauche = Canvas(container, bg="#0000ff", width=60, height=60)
        self.rectangleBleuSupDroit = Canvas(container, bg="#0000ff", width=60, height=50)
        self.rectangleBleuInfGauche = Canvas(container, bg="#0000ff", width=85, height=350)
        self.rectangleBleuInfDroit = Canvas(container, bg="#0000ff", width=355, height=340)
