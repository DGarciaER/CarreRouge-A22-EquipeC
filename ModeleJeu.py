...
class Rectangles:
    ...
    def __init__(self, container):
        ...
        self.listeRectangles = [
                    c31.Rectangle(container, c31.Vecteur(0, 0), self.listeTaillesRectangles[0][0], self.listeTaillesRectangles[0][1], 0, '#0000ff', '#0000ff', 0),  #rectangle haut gauche
                    c31.Rectangle(container, c31.Vecteur(0, 0), self.listeTaillesRectangles[1][0], self.listeTaillesRectangles[1][1], 0, '#0000ff', '#0000ff', 0),   #rectange haut droite
                    c31.Rectangle(container, c31.Vecteur(0, 0), self.listeTaillesRectangles[2][0], self.listeTaillesRectangles[2][1], 0, '#0000ff', '#0000ff', 0),   #rectange bas gauche
                    c31.Rectangle(container, c31.Vecteur(0, 0), self.listeTaillesRectangles[3][0], self.listeTaillesRectangles[3][1], 0, '#0000ff', '#0000ff', 0)   #rectange bas droite
                    ]
